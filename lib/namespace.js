...
var Namespace = createClass({
  ...
  useDefault: function() {
    ...
    this
      .detect(RA.isNull, elements.NullElement, false)
      .detect(RA.isString, elements.StringElement, false)
      .detect(RA.isNumber, elements.NumberElement, false)
      .detect(RA.isBoolean, elements.BooleanElement, false)
      .detect(RA.isArray, elements.ArrayElement, false)
      .detect(RA.isObject, elements.ObjectElement, false);
